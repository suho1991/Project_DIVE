		...
		<div class="choice-sector-content">
			<section class="choice">
				<div class="choice_btn">
					...
					</span> <span class="signup_sector"> <a href="/"> <input
							type="button" class="signup_btn" value="H O M E">
					</a>
					</span>
				</div>
			</section>
				...
				<div class="customer_inform">
					<form action="/user/deleteUser" method="POST">
						<div class="customer_inform_pass_sector">
							<input type="text" class="customer_inform_pass"
						...
						<div>
							<input type="submit" class="connect_btn" value="remove">
						</div>
